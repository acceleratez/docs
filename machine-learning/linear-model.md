...
![9.webp](https://i.loli.net/2018/10/17/5bc722b0c7748.webp)
...
![13.webp](https://i.loli.net/2018/10/17/5bc723b863ebb.webp)![14.webp](https://i.loli.net/2018/10/17/5bc723b85bfa9.webp)

想让同类样本点的投影点尽可能接近，不同类样本点投影之间尽可能远，即：让各类的协方差之和尽可能小，不用类之间中心的距离尽可能大。基于这样的考虑，LDA定义了两个散度矩阵。

+ 类内散度矩阵（within-class scatter matrix）

![15.webp](https://i.loli.net/2018/10/17/5bc723b8156e1.webp)

+ 类间散度矩阵(between-class scaltter matrix)

![16.webp](https://i.loli.net/2018/10/17/5bc723b7e9db3.webp)

因此得到了LDA的最大化目标：“广义瑞利商”（generalized Rayleigh quotient）。

![17.webp](https://i.loli.net/2018/10/17/5bc723b7e8a61.webp)

从而分类问题转化为最优化求解w的问题，当求解出w后，对新的样本进行分类时，只需将该样本点投影到这条直线上，根据与各个类别的中心值进行比较，从而判定出新样本与哪个类别距离最近。求解w的方法如下所示，使用的方法为λ乘子。

![18.webp](https://i.loli.net/2018/10/17/5bc723b83d5e0.webp)
...
2. 最为经典的拆分策略有三种：“一对一”（OvO）、“一对其余”（OvR）和“多对多”（MvM），核心思想与示意图如下所示。
   ...
   + OvR：给定数据集D，假定其中有N个真实类别，每次取出一个类作为正类，剩余的所有类别作为一个新的反类，从而产生N个二分类学习器，在测试阶段，得出N个结果，若仅有一个学习器预测为正类，则对应的类标作为最终分类结果。
     ...
     ![19.webp](https://i.loli.net/2018/10/17/5bc723b862bfb.webp)
...
![20.webp](https://i.loli.net/2018/10/17/5bc723b8300d5.webp)
...
3.  直接基于原数据集进行学习，对预测值进行“再缩放”处理。其中再缩放也是代价敏感学习的基础。![21.webp](https://i.loli.net/2018/10/17/5bc726fe87ae2.webp)
