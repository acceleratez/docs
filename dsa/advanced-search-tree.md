...
3. “子孙同侧”：使用`zig-zig`或`zag-zag`操作，进行调整。注意，这里和之前所讲的AVL树的`zig-zig`或`zag-zag`操作的次序不同。
  ...
  >
  > ![img2.imgtp.com/2024/05/25/1qlgA5Sx.webp](https://img2.imgtp.com/2024/05/25/1qlgA5Sx.webp)
  >
  > 这引发了局部树的拓扑结构的不同。
...
![](https://redisbook.readthedocs.io/en/latest/_images/skiplist.webp)
...
![B-树上溢](https://img2.imgtp.com/2024/05/26/ohs2cpPj.webp)
...
![](https://img2.imgtp.com/2024/05/26/xjMHyjgM.webp)
